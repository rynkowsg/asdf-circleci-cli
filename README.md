...
asdf install circleci-cli 1.0.48773

# Set a version globally (on your ~/.tool-versions file)
asdf set --home circleci-cli 1.0.48773

# Set a version locally (on the .tool-versions file in the current directory)
asdf set circleci-cli 1.0.48773
